...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WT)
      ...
      CALL FFV1_0(W(1,7),W(1,5),W(1,9),GC_11,AMP(12,1))
      CALL FFV1_0(W(1,7),W(1,5),W(1,12),GC_11,AMP(2,1))
      CALL FFV1_0(W(1,8),W(1,6),W(1,9),GC_11,AMP(11,1))
      CALL FFV1_0(W(1,8),W(1,6),W(1,12),GC_11,AMP(1,1)) ! count 1
