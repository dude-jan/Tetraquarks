...
VVS2 = Lorentz(name = 'VVS2',
               spins = [ 3, 3, 1 ],
               structure = '-2*Epsilon(1,2,-1,-2)*P(-2,2)*P(-1,1) + 2*Epsilon(1,2,-1,-2)*P(-2,1)*P(-1,2)')
...
VVS4 = Lorentz(name = 'VVS4',
               spins = [ 3, 3, 1 ],
               structure = '3*Epsilon(1,2,-1,-2)*P(-2,2)*P(-1,1) - Epsilon(1,2,-1,-2)*P(-2,1)*P(-1,2)')
...
VVVS2 = Lorentz(name = 'VVVS2',
                spins = [ 3, 3, 3, 1 ],
                structure = '-2*Epsilon(1,2,3,-1)*P(-1,1)')

VVVS3 = Lorentz(name = 'VVVS3',
                spins = [ 3, 3, 3, 1 ],
                structure = '-4*Epsilon(1,2,3,-1)*P(-1,1)')

VVVS4 = Lorentz(name = 'VVVS4',
                spins = [ 3, 3, 3, 1 ],
                structure = '-4*Epsilon(1,2,3,-1)*P(-1,2)')

VVVS5 = Lorentz(name = 'VVVS5',
                spins = [ 3, 3, 3, 1 ],
                structure = '-2*Epsilon(1,2,3,-1)*P(-1,3)')

VVVS6 = Lorentz(name = 'VVVS6',
                spins = [ 3, 3, 3, 1 ],
                structure = '-4*Epsilon(1,2,3,-1)*P(-1,3)')
