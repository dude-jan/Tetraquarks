...
s__plus__ = Particle(pdg_code = 6100002,
                     name = 's+',
                     antiname = 's-',
                     spin = 1,
                     color = 1,
...
s__minus__ = s__plus__.anti()

s__plus____plus__ = Particle(pdg_code = 6100003,
                             name = 's++',
                             antiname = 's--',
                             spin = 1,
                             color = 1,
...
s__minus____minus__ = s__plus____plus__.anti()
