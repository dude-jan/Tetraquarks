...
# Generate events
echo "$(my_date): Point 0004: Starting event generation" | tee -a timekeeping.log
/home/manu/tools/MG5_aMC_v3_5_13/bin/mg5_aMC mg.txt > /dev/null 2>&1
...
echo "$(my_date): Point 0004: Finished run" | tee -a timekeeping.log
