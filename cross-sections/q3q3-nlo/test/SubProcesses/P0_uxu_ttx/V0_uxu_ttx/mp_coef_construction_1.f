...
C     Coefficient construction for loop diagram with ID 5
      ...
      CALL MP_FFV1L1_2(PL(0,10),W(1,6),GC_5,ZERO,ZERO,PL(0,11),COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      CALL MP_FFV1L3_1(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,12),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,12))
      CALL MP_FFV1L2P0_3(PL(0,12),W(1,2),GC_5,ZERO,ZERO,PL(0,13),COEFS)
...
C     Coefficient construction for loop diagram with ID 11
      CALL MP_FFV1L2_1(PL(0,0),W(1,5),GC_5,MDL_MB,ZERO,PL(0,23),COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,23))
      CALL MP_FFV1L2_1(PL(0,23),W(1,6),GC_5,MDL_MB,ZERO,PL(0,24),COEFS)
...
C     Coefficient construction for loop diagram with ID 12
      CALL MP_FFV1L2_1(PL(0,0),W(1,5),GC_5,MDL_MT,MDL_WT,PL(0,25)
     $ ,COEFS)
      CALL MP_UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,25))
      CALL MP_FFV1L2_1(PL(0,25),W(1,6),GC_5,MDL_MT,MDL_WT,PL(0,26)
     $ ,COEFS)
