...
C     Coefficient construction for loop diagram with ID 2
      ...
      CALL VVV1L2P0_1(PL(0,1),W(1,6),GC_4,ZERO,ZERO,PL(0,2),COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      CALL FFV1L1P0_3(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,9),COEFS)
      CALL UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,9))
      CALL FFV1L3_2(PL(0,9),W(1,2),GC_5,ZERO,ZERO,PL(0,10),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,9),4,COEFS,4,4,WL(1,0,1,10))
      CALL FFV1L1_2(PL(0,10),W(1,6),GC_5,ZERO,ZERO,PL(0,11),COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      CALL FFV1L3_1(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,12),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,12))
      CALL FFV1L2P0_3(PL(0,12),W(1,2),GC_5,ZERO,ZERO,PL(0,13),COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,12),4,COEFS,4,4,WL(1,0,1,13))
      CALL VVV1L2P0_1(PL(0,13),W(1,6),GC_4,ZERO,ZERO,PL(0,14),COEFS)
...
C     Coefficient construction for loop diagram with ID 7
      CALL FFV1L3_2(PL(0,13),W(1,4),GC_5,MDL_MT,MDL_WT,PL(0,15),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,13),4,COEFS,4,4,WL(1,0,1,15))
      CALL FFV1L1P0_3(PL(0,15),W(1,3),GC_5,ZERO,ZERO,PL(0,16),COEFS)
...
C     Coefficient construction for loop diagram with ID 8
      CALL FFV1L3_1(PL(0,13),W(1,3),GC_5,MDL_MT,MDL_WT,PL(0,17),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,13),4,COEFS,4,4,WL(1,0,1,17))
      CALL FFV1L2P0_3(PL(0,17),W(1,4),GC_5,ZERO,ZERO,PL(0,18),COEFS)
...
C     Coefficient construction for loop diagram with ID 9
      CALL GHGHGL2_1(PL(0,0),W(1,5),GC_4,ZERO,ZERO,PL(0,19),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,0),1,COEFS,1,1,WL(1,0,1,19))
      CALL GHGHGL2_1(PL(0,19),W(1,6),GC_4,ZERO,ZERO,PL(0,20),COEFS)
...
C     Coefficient construction for loop diagram with ID 10
      CALL FFV1L2_1(PL(0,0),W(1,5),GC_5,ZERO,ZERO,PL(0,21),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,21))
      CALL FFV1L2_1(PL(0,21),W(1,6),GC_5,ZERO,ZERO,PL(0,22),COEFS)
...
C     Coefficient construction for loop diagram with ID 11
      CALL FFV1L2_1(PL(0,0),W(1,5),GC_5,MDL_MB,ZERO,PL(0,23),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,23))
      CALL FFV1L2_1(PL(0,23),W(1,6),GC_5,MDL_MB,ZERO,PL(0,24),COEFS)
...
C     Coefficient construction for loop diagram with ID 12
      CALL FFV1L2_1(PL(0,0),W(1,5),GC_5,MDL_MT,MDL_WT,PL(0,25),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,25))
      CALL FFV1L2_1(PL(0,25),W(1,6),GC_5,MDL_MT,MDL_WT,PL(0,26),COEFS)
