...
C     Coefficient construction for loop diagram with ID 5
      ...
      CALL FFV1L2_1(PL(0,10),W(1,6),GC_5,ZERO,ZERO,PL(0,11),COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      CALL FFV1L3_2(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,12),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,12))
      CALL FFV1L1P0_3(PL(0,12),W(1,2),GC_5,ZERO,ZERO,PL(0,13),COEFS)
