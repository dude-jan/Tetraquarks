...
#
################################################################################
# /home/manu/runarea/sextet-fermions/repo/cross-sections/q3q3-nlo/test/bin/internal/histograms.py /home/manu/runarea/sextet-fermions/repo/cross-sections/q3q3-nlo/test/SubProcesses/P0_gg_ttx/all_G1/MADatNLO.HwU /home/manu/runarea/sextet-fermions/repo/cross-sections/q3q3-nlo/test/SubProcesses/P0_uxu_ttx/all_G1/MADatNLO.HwU /home/manu/runarea/sextet-fermions/repo/cross-sections/q3q3-nlo/test/SubProcesses/P0_uux_ttx/all_G1/MADatNLO.HwU --out=/home/manu/runarea/sextet-fermions/repo/cross-sections/q3q3-nlo/test/Events/run_01/MADatNLO --gnuplot --band=[] --lhapdf-config=/home/manu/tools/MG5_aMC_v3_5_13/HEPTools/lhapdf6_py3/bin/lhapdf-config --sum --keep_all_weights --no_open
reset
...
set format y '10^{%T}'
set yrange [5.4401e+02:8.3313e+03]
...
'MADatNLO.HwU' index 0 using (($1+$2)/2):($3 < 0 ? sqrt(-1) : $3) ls 1 title '#1, central value, dynamical\_scale\_choice=-1'
#-- rendering subhistograms 'Relative scale and PDF uncertainty'
unset label
unset format
set yrange [-1.7354e-01:1.4703e-01]
...
set format y '10^{%T}'
set yrange [3.2390e+02:6.6065e+03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
...
'MADatNLO.HwU' index 1 using (($1+$2)/2):($3 < 0 ? sqrt(-1) : $3) ls 1 title '#1, central value, dynamical\_scale\_choice=-1'
#-- rendering subhistograms 'Relative scale and PDF uncertainty'
unset label
unset format
set yrange [-3.4735e-01:4.0140e-01]
set origin 0.0000e+00, 3.5000e-01
set size 1.0000e+00, 1.5000e-01
set mytics 2
set ytics auto
